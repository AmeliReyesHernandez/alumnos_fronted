...
const iniciarSesion = async () => {
  if (modoRegistro.value) {
    ...
    // Modo Registro
    try {
      const response = await axios.post(`https://alumnos-backend-bw34.onrender.com/usuarios/registro`, loginAuth.value);
    ...
    // Modo Login
    try {
      const response = await axios.post(`https://alumnos-backend-bw34.onrender.com/usuarios/login`, loginAuth.value);
